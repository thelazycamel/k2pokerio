defmodule K2pokerIo.JoinGameCommand do
  ...
  defp join_game(user_tournament_detail, game) do
    game_changeset = Game.join_changeset(game, %{player2_id: user_tournament_detail.player_id, waiting_for_players: false})
  ...
  defp create_new_game(user_tournament_detail) do
    changeset = Game.create_new_changeset(%Game{}, %{player1_id: user_tournament_detail.player_id,
                                                     tournament_id: user_tournament_detail.tournament_id,
                                                     value: user_tournament_detail.current_score,
